...
$allowed_extensions = array('jpg', 'jpeg', 'png', 'gif','webp','jfif');
...
<?php } }else{//WE do not have category?>
<option value="0">No Measurement Found</option>
<?php
} ?>
              </select>
      </div>
      ...
      <div class="">
        ...
        <input class="w-full h-10 px-3 text-base placeholder-gray-300 border border-slate-400 rounded-lg focus:outline-none placeholder:text-xs" type="text" placeholder="e.g 1 for 1L or 400 for 400g" name="qty"/>
      </div>
   ...
   <div class="w-full flex justify-center items-center">
     <input class="w-1/2 h-10 px-3 mt-6 cursor-pointer bg-teal-500 text-white focus:outline-none focus:bg-teal-600" type="submit" name="add" value="Add"/>
   </div>
