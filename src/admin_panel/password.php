...
if(isset($_POST['save_pass'])){
    ...
    $sql = "UPDATE tbl_admin SET username = '$username',password='$password', phone='$number'";
...
<div class="font-semibold my-2">
        ...
        <input class="w-full h-10 px-3 text-base placeholder-gray-300 border-2 border-slate-400 rounded-lg focus:outline-none" type="text" value="<?php echo $_SESSION['user'];?>" name="admin_user" required/>
      </div>

 <div class="font-semibold">
        <label class="block mb-1 text-gray-500" for="forms-labelOverInputCode">Phone</label>
        <input class="w-full h-10 px-3 text-base border-slate-400 placeholder-gray-300 border-2 rounded-lg focus:outline-none" type="tel" value="<?php echo $phone;?>" name="phone" required/>
      </div>

    <div class="font-semibold">
        <label class="block mb-1 text-gray-500" for="forms-labelOverInputCode">Password</label>
        <input class="w-full h-10 px-3 text-base border-slate-400 placeholder-gray-300 border-2 rounded-lg focus:outline-none" type="password" placeholder="old password or enter new password" name="admin_pass" required/>
      </div>
