	...
	foreach($_SESSION["products"] as $product){ //loop though items and prepare html content
		...
		//set variables to use them in HTML content below
			...
			if($promo == 0){
			 ...
			 if(!empty($ms)){
                       $product_name = $product_name."(".$qty.''. $ms.")";
                        }else{
...
$pnames.="%0A............................%0AQty:".$product_qty."%0AProduct:".$product_name."%0APrice:"."$currency$item_price";
 ...
 <a target='_blank' href='https://wa.me/$phoneNumber?text=Hi!,%20I%20will%20like%20to%20Order:$pnames%0A............................................%0ATotal::%20$currency$gt%0A' class=\"checkout price \" >Check out via whatsapp</a><i class=\"fa-brands fa-whatsapp ml-2\"></i>
 </div>
  </div>
  </div>";
